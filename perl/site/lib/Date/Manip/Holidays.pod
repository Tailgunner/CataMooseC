...
the world), you could do it in one of the following ways:
...
that's no longer a work day) and define the work day two week days after
Christmas, NOT the day after Christmas.

NOTE that since the definitions are stored in a list, NOT a hash (as
they were in Date::Manip 5.xx), you can use the definition:

   1*12:0:24:0:0:0*FW1  = Christmas
   1*12:0:24:0:0:0*FW1  = Boxing

to defined the days even though both recurrences are identical.
